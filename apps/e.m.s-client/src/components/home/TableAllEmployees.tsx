    ...
    <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            {data?.map((employee) => {
                ...
                <td className="px-6 py-4">
                <a type="button" onClick={()=> navigate('/EditEmployeeData')} data-modal-show="editUserModal" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit user</a>
                </td>
            </tr>
                )
            })}
